...
PokemonTags _$PokemonTagsFromJson(Map<String, dynamic> json) {
  return _PokemonTags.fromJson(json);
}
...
/// @nodoc
class _$PokemonTagsCopyWithImpl<$Res, $Val extends PokemonTags>
    implements $PokemonTagsCopyWith<$Res> {
  _$PokemonTagsCopyWithImpl(this._value, this._then);
...
class __$$PokemonTagsImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$PokemonTagsImpl(
      tag: null == tag
          ? _value.tag
          : tag // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$PokemonTagsImpl implements _PokemonTags {
  ...
  _$$PokemonTagsImplCopyWith<_$PokemonTagsImpl> get copyWith =>
      __$$PokemonTagsImplCopyWithImpl<_$PokemonTagsImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$PokemonTagsImplToJson(
      this,
    );
  }
}
